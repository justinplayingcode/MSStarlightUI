...
import { Onboarding, TypeOfTest, toastType } from "../../../../model/enum";
...
import Api from "../../../../api";
import { TestList } from "../../../../model/doctorModel";
...
function NormalProgress({ ...props }: INormalProgressPorops) {
  ...
  const validateInput = (key: any, value: string | any[], messageErr: any) => {
    switch(key) {
      case 'height':
  ...
  const onChangeCurrentState = (key: string, value: string | number | undefined) => {
    const newState = {
      ...currentState,
      [key]: value
    }
  ...
  const _onchange = (key: string, value: string | number | any[] | undefined, messageErr: string) => {
    onChangeCurrentState(key, value as any);
    validateInput(key, value as any, messageErr)
  }
  ...
  const onRenderTestResult = (item: any) => {
    return (
  ...
  const onChangeOnboarding = (_: any, option: any) => {
