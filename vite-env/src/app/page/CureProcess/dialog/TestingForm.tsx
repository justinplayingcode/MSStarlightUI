...
import FileItem from '../../../common/FileUpload/FileItem';
...
export const TestingForm = ({...props}: ITestingProps) => {
    ...
    const _onchange = (key: any, value: any, index: number, id?: string | undefined) => {
    ...
    const renderTestResult = (item: ITest, index: any) => {
