...
import Api from "../../../../api";
import { ApiStatus, TableType, exportCsvType, toastType } from "../../../../model/enum";
...
const PatientInOnboarding = () => {
  ...
  const handleChangeDate = (value: SetStateAction<Date | undefined>) => {
    setSelectedDate(value);
    setDateError(undefined as any)
  }

  const handleChangeDecs = (_: any, value: string) => {
    setDescription(value);
    if(value!.trim() !== "") {
      setDescError(undefined as any)
    } else {
    ...
    return <>
      ...
      <div className="make-appointment-dialog">
        ...
        <TextField
          className='textfield'
          multiline
          onChange={handleChangeDecs as any}
          resizable={false}
