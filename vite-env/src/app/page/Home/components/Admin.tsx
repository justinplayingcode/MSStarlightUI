...
import Api from "../../../../api";
import { closeLoading, openLoading } from "../../../../redux/reducers";
import { BarChart } from "../../../common/ChartComponents/barChart";
import { AreaChart } from "../../../common/ChartComponents/areaChart";
import { DoughnutChart } from "../../../common/ChartComponents/doughnutChart";
...
const valuesForDoughnutChart = (data: any) => {
  data.sort((a: any, b: any) => b.total - a.total);
  const remainingTotal = data.slice(9).reduce((sum: any, item: { total: any; }) => sum + item.total, 0);
  return [
    ...data.slice(0, 9),
    {
