...
import Api from '../../../api';
import { ApiStatus, DepartmentType, TableType, toastType } from '../../../model/enum';
...
const AppointmentStep = ({ ...props }: any) => {
    ...
    const handldeChangeDropDown = (_: any ,option: any) => {
    ...
    const handleChangeDecs = (_: any, value: any) => {
    ...
    const basicInfoRender = (key: any, value: any, index: any) => {
      return (
    ...
    const handleSubmit = () => {
      const reqBody = {
        departmentId,
        appointmentDate: Convert.datetommddyyyy(selectedDate as any),
