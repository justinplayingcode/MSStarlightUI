...
import { ApiStatus, TableType } from '../../../model/enum';
...
class UniformTable extends React.Component<IUniformTableProps, IUniformTableState> {
    ...
    componentDidMount(): void {
      ...
      const detailListElementHeight = (detailListElement as any).clientHeight;
    ...
    private onKeyDownSearch = (e: any) => {
      if(e.key === "Enter") {
        (this._buttonSearch.current as any).click()
      }
    }
        ...
        return (
            ...
            >
                <div className='details-list'>
                    ...
                    <div className='details-list-wrapper' ref={this._detailListRef as any}>
