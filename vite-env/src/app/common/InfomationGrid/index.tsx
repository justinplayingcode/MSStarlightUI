...
import './index.scss';
import { onFormatDate } from "../../../model/userModel";
        ...
        return(
            ...
            >
                <Stack.Item
                    ...
                    className={css("label-section", { 'has-background': props.isDataLoaded} as any)}
                    disableShrink
                    grow={0}
                >
                ...
                <Stack.Item
                    style={{width: !!props.customValueWidth && props.customValueWidth} as any}
