...
import { Callout, DefaultButton, Icon, Persona, PersonaInitialsColor, PersonaSize, Stack } from "@fluentui/react";
import './index.scss'
...
export const Avatar = (props: IAvatarProps) => {
    ...
    const renderCallOut = ():JSX.Element => {
      return <div className="avatar-callout">
        <DefaultButton className="buttonAvatar" onClick={() => {setIsCalloutVisible(false); navigate('/home/profile')}}>
          <Persona
            text={info?.fullname}
